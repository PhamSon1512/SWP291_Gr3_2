...
<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>FPTU - Club Management System</title>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="Phone Number" class="form-control" placeholder="Phone Number" required="">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="accept-tnc-check">Remember</a></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="mx-auto">
                                            <span class="mb-0 mt-3"><small class="text-dark me-2">Already have an account ?</small> <a href="login.html" class="ms-auto">Sign in</a> <a href="#" class="ms-4">Forgot Password</a></span>
