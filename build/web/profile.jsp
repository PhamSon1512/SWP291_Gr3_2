                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <input name="username" readonly value="<%= account.getName() %>" id="name" type="text" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-4">
                                                ...
                                                <input name="email" readonly value="<%= account.getEmail() %>" id="email" type="email" class="form-control">
                                            </div>
                                        </div>
